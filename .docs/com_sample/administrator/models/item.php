...
class SampleModelItem extends JModelAdmin
{
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm('com_sample.model_name', 'model_name', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form)) {
			return false;
		}
	...
	$data = JFactory::getApplication()->getUserState('com_sample.edit.model_name.data', array());
