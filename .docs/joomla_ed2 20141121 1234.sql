...
-- Дата скрипта: 21.11.2014 12:34:24
...
--
-- Описание для таблицы jed2_assets
--
DROP TABLE IF EXISTS jed2_assets;
CREATE TABLE jed2_assets (
...
--
-- Описание для таблицы jed2_associations
--
DROP TABLE IF EXISTS jed2_associations;
CREATE TABLE jed2_associations (
...
--
-- Описание для таблицы jed2_banner_clients
--
DROP TABLE IF EXISTS jed2_banner_clients;
CREATE TABLE jed2_banner_clients (
...
--
-- Описание для таблицы jed2_banner_tracks
--
DROP TABLE IF EXISTS jed2_banner_tracks;
CREATE TABLE jed2_banner_tracks (
...
--
-- Описание для таблицы jed2_banners
--
DROP TABLE IF EXISTS jed2_banners;
CREATE TABLE jed2_banners (
  id INT(11) NOT NULL AUTO_INCREMENT,
...
--
-- Описание для таблицы jed2_categories
--
DROP TABLE IF EXISTS jed2_categories;
CREATE TABLE jed2_categories (
  id INT(11) NOT NULL AUTO_INCREMENT,
...
--
-- Описание для таблицы jed2_contact_details
--
DROP TABLE IF EXISTS jed2_contact_details;
CREATE TABLE jed2_contact_details (
  id INT(11) NOT NULL AUTO_INCREMENT,
  name VARCHAR(255) NOT NULL DEFAULT '',
  alias VARCHAR(255) BINARY CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Описание для таблицы jed2_content
--
DROP TABLE IF EXISTS jed2_content;
CREATE TABLE jed2_content (
...
--
-- Описание для таблицы jed2_content_frontpage
--
DROP TABLE IF EXISTS jed2_content_frontpage;
CREATE TABLE jed2_content_frontpage (
...
--
-- Описание для таблицы jed2_content_rating
--
DROP TABLE IF EXISTS jed2_content_rating;
CREATE TABLE jed2_content_rating (
  content_id INT(11) NOT NULL DEFAULT 0,
...
--
-- Описание для таблицы jed2_core_log_searches
--
DROP TABLE IF EXISTS jed2_core_log_searches;
CREATE TABLE jed2_core_log_searches (
...
--
-- Описание для таблицы jed2_extensions
--
DROP TABLE IF EXISTS jed2_extensions;
CREATE TABLE jed2_extensions (
...
--
-- Описание для таблицы jed2_finder_filters
--
DROP TABLE IF EXISTS jed2_finder_filters;
CREATE TABLE jed2_finder_filters (
...
--
-- Описание для таблицы jed2_finder_links
--
DROP TABLE IF EXISTS jed2_finder_links;
CREATE TABLE jed2_finder_links (
...
--
-- Описание для таблицы jed2_finder_links_terms0
--
DROP TABLE IF EXISTS jed2_finder_links_terms0;
CREATE TABLE jed2_finder_links_terms0 (
...
--
-- Описание для таблицы jed2_finder_links_terms1
--
DROP TABLE IF EXISTS jed2_finder_links_terms1;
CREATE TABLE jed2_finder_links_terms1 (
  link_id INT(10) UNSIGNED NOT NULL,
  term_id INT(10) UNSIGNED NOT NULL,
  weight FLOAT UNSIGNED NOT NULL,
  PRIMARY KEY (link_id, term_id),
...
--
-- Описание для таблицы jed2_finder_links_terms2
--
DROP TABLE IF EXISTS jed2_finder_links_terms2;
CREATE TABLE jed2_finder_links_terms2 (
  link_id INT(10) UNSIGNED NOT NULL,
  term_id INT(10) UNSIGNED NOT NULL,
  weight FLOAT UNSIGNED NOT NULL,
  PRIMARY KEY (link_id, term_id),
...
--
-- Описание для таблицы jed2_finder_links_terms3
--
DROP TABLE IF EXISTS jed2_finder_links_terms3;
CREATE TABLE jed2_finder_links_terms3 (
  link_id INT(10) UNSIGNED NOT NULL,
  term_id INT(10) UNSIGNED NOT NULL,
  weight FLOAT UNSIGNED NOT NULL,
  PRIMARY KEY (link_id, term_id),
...
--
-- Описание для таблицы jed2_finder_links_terms4
--
DROP TABLE IF EXISTS jed2_finder_links_terms4;
CREATE TABLE jed2_finder_links_terms4 (
  link_id INT(10) UNSIGNED NOT NULL,
  term_id INT(10) UNSIGNED NOT NULL,
  weight FLOAT UNSIGNED NOT NULL,
  PRIMARY KEY (link_id, term_id),
...
--
-- Описание для таблицы jed2_finder_links_terms5
--
DROP TABLE IF EXISTS jed2_finder_links_terms5;
CREATE TABLE jed2_finder_links_terms5 (
  link_id INT(10) UNSIGNED NOT NULL,
  term_id INT(10) UNSIGNED NOT NULL,
  weight FLOAT UNSIGNED NOT NULL,
  PRIMARY KEY (link_id, term_id),
...
--
-- Описание для таблицы jed2_finder_links_terms6
--
DROP TABLE IF EXISTS jed2_finder_links_terms6;
CREATE TABLE jed2_finder_links_terms6 (
  link_id INT(10) UNSIGNED NOT NULL,
  term_id INT(10) UNSIGNED NOT NULL,
  weight FLOAT UNSIGNED NOT NULL,
  PRIMARY KEY (link_id, term_id),
...
--
-- Описание для таблицы jed2_finder_links_terms7
--
DROP TABLE IF EXISTS jed2_finder_links_terms7;
CREATE TABLE jed2_finder_links_terms7 (
  link_id INT(10) UNSIGNED NOT NULL,
  term_id INT(10) UNSIGNED NOT NULL,
  weight FLOAT UNSIGNED NOT NULL,
  PRIMARY KEY (link_id, term_id),
...
--
-- Описание для таблицы jed2_finder_links_terms8
--
DROP TABLE IF EXISTS jed2_finder_links_terms8;
CREATE TABLE jed2_finder_links_terms8 (
  link_id INT(10) UNSIGNED NOT NULL,
  term_id INT(10) UNSIGNED NOT NULL,
  weight FLOAT UNSIGNED NOT NULL,
  PRIMARY KEY (link_id, term_id),
...
--
-- Описание для таблицы jed2_finder_links_terms9
--
DROP TABLE IF EXISTS jed2_finder_links_terms9;
CREATE TABLE jed2_finder_links_terms9 (
  link_id INT(10) UNSIGNED NOT NULL,
  term_id INT(10) UNSIGNED NOT NULL,
  weight FLOAT UNSIGNED NOT NULL,
  PRIMARY KEY (link_id, term_id),
...
--
-- Описание для таблицы jed2_finder_links_termsa
--
DROP TABLE IF EXISTS jed2_finder_links_termsa;
CREATE TABLE jed2_finder_links_termsa (
  link_id INT(10) UNSIGNED NOT NULL,
  term_id INT(10) UNSIGNED NOT NULL,
  weight FLOAT UNSIGNED NOT NULL,
  PRIMARY KEY (link_id, term_id),
...
--
-- Описание для таблицы jed2_finder_links_termsb
--
DROP TABLE IF EXISTS jed2_finder_links_termsb;
CREATE TABLE jed2_finder_links_termsb (
  link_id INT(10) UNSIGNED NOT NULL,
  term_id INT(10) UNSIGNED NOT NULL,
  weight FLOAT UNSIGNED NOT NULL,
  PRIMARY KEY (link_id, term_id),
...
--
-- Описание для таблицы jed2_finder_links_termsc
--
DROP TABLE IF EXISTS jed2_finder_links_termsc;
CREATE TABLE jed2_finder_links_termsc (
  link_id INT(10) UNSIGNED NOT NULL,
  term_id INT(10) UNSIGNED NOT NULL,
  weight FLOAT UNSIGNED NOT NULL,
  PRIMARY KEY (link_id, term_id),
...
--
-- Описание для таблицы jed2_finder_links_termsd
--
DROP TABLE IF EXISTS jed2_finder_links_termsd;
CREATE TABLE jed2_finder_links_termsd (
  link_id INT(10) UNSIGNED NOT NULL,
  term_id INT(10) UNSIGNED NOT NULL,
  weight FLOAT UNSIGNED NOT NULL,
  PRIMARY KEY (link_id, term_id),
...
--
-- Описание для таблицы jed2_finder_links_termse
--
DROP TABLE IF EXISTS jed2_finder_links_termse;
CREATE TABLE jed2_finder_links_termse (
  link_id INT(10) UNSIGNED NOT NULL,
  term_id INT(10) UNSIGNED NOT NULL,
  weight FLOAT UNSIGNED NOT NULL,
  PRIMARY KEY (link_id, term_id),
...
--
-- Описание для таблицы jed2_finder_links_termsf
--
DROP TABLE IF EXISTS jed2_finder_links_termsf;
CREATE TABLE jed2_finder_links_termsf (
  link_id INT(10) UNSIGNED NOT NULL,
  term_id INT(10) UNSIGNED NOT NULL,
  weight FLOAT UNSIGNED NOT NULL,
  PRIMARY KEY (link_id, term_id),
...
--
-- Описание для таблицы jed2_finder_taxonomy
--
DROP TABLE IF EXISTS jed2_finder_taxonomy;
CREATE TABLE jed2_finder_taxonomy (
  id INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  parent_id INT(10) UNSIGNED NOT NULL DEFAULT 0,
  title VARCHAR(255) NOT NULL,
...
--
-- Описание для таблицы jed2_finder_taxonomy_map
--
DROP TABLE IF EXISTS jed2_finder_taxonomy_map;
CREATE TABLE jed2_finder_taxonomy_map (
  link_id INT(10) UNSIGNED NOT NULL,
...
--
-- Описание для таблицы jed2_finder_terms
--
DROP TABLE IF EXISTS jed2_finder_terms;
CREATE TABLE jed2_finder_terms (
...
--
-- Описание для таблицы jed2_finder_terms_common
--
DROP TABLE IF EXISTS jed2_finder_terms_common;
CREATE TABLE jed2_finder_terms_common (
  term VARCHAR(75) NOT NULL,
...
--
-- Описание для таблицы jed2_finder_tokens
--
DROP TABLE IF EXISTS jed2_finder_tokens;
CREATE TABLE jed2_finder_tokens (
  term VARCHAR(75) NOT NULL,
  stem VARCHAR(75) NOT NULL,
  common TINYINT(1) UNSIGNED NOT NULL DEFAULT 0,
  phrase TINYINT(1) UNSIGNED NOT NULL DEFAULT 0,
...
--
-- Описание для таблицы jed2_finder_tokens_aggregate
--
DROP TABLE IF EXISTS jed2_finder_tokens_aggregate;
CREATE TABLE jed2_finder_tokens_aggregate (
  term_id INT(10) UNSIGNED NOT NULL,
...
--
-- Описание для таблицы jed2_finder_types
--
DROP TABLE IF EXISTS jed2_finder_types;
CREATE TABLE jed2_finder_types (
  id INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Описание для таблицы jed2_languages
--
DROP TABLE IF EXISTS jed2_languages;
CREATE TABLE jed2_languages (
...
--
-- Описание для таблицы jed2_menu
--
DROP TABLE IF EXISTS jed2_menu;
CREATE TABLE jed2_menu (
  id INT(11) NOT NULL AUTO_INCREMENT,
...
--
-- Описание для таблицы jed2_menu_types
--
DROP TABLE IF EXISTS jed2_menu_types;
CREATE TABLE jed2_menu_types (
  id INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Описание для таблицы jed2_messages
--
DROP TABLE IF EXISTS jed2_messages;
CREATE TABLE jed2_messages (
...
--
-- Описание для таблицы jed2_messages_cfg
--
DROP TABLE IF EXISTS jed2_messages_cfg;
CREATE TABLE jed2_messages_cfg (
...
--
-- Описание для таблицы jed2_modules
--
DROP TABLE IF EXISTS jed2_modules;
CREATE TABLE jed2_modules (
  id INT(11) NOT NULL AUTO_INCREMENT,
...
--
-- Описание для таблицы jed2_modules_menu
--
DROP TABLE IF EXISTS jed2_modules_menu;
CREATE TABLE jed2_modules_menu (
...
--
-- Описание для таблицы jed2_newsfeeds
--
DROP TABLE IF EXISTS jed2_newsfeeds;
CREATE TABLE jed2_newsfeeds (
  catid INT(11) NOT NULL DEFAULT 0,
  id INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Описание для таблицы jed2_overrider
--
DROP TABLE IF EXISTS jed2_overrider;
CREATE TABLE jed2_overrider (
...
--
-- Описание для таблицы jed2_redirect_links
--
DROP TABLE IF EXISTS jed2_redirect_links;
CREATE TABLE jed2_redirect_links (
  id INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Описание для таблицы jed2_schemas
--
DROP TABLE IF EXISTS jed2_schemas;
CREATE TABLE jed2_schemas (
...
--
-- Описание для таблицы jed2_session
--
DROP TABLE IF EXISTS jed2_session;
CREATE TABLE jed2_session (
...
--
-- Описание для таблицы jed2_template_styles
--
DROP TABLE IF EXISTS jed2_template_styles;
CREATE TABLE jed2_template_styles (
  id INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Описание для таблицы jed2_update_categories
--
DROP TABLE IF EXISTS jed2_update_categories;
CREATE TABLE jed2_update_categories (
...
--
-- Описание для таблицы jed2_update_sites
--
DROP TABLE IF EXISTS jed2_update_sites;
CREATE TABLE jed2_update_sites (
...
--
-- Описание для таблицы jed2_update_sites_extensions
--
DROP TABLE IF EXISTS jed2_update_sites_extensions;
CREATE TABLE jed2_update_sites_extensions (
...
--
-- Описание для таблицы jed2_updates
--
DROP TABLE IF EXISTS jed2_updates;
CREATE TABLE jed2_updates (
...
--
-- Описание для таблицы jed2_user_notes
--
DROP TABLE IF EXISTS jed2_user_notes;
CREATE TABLE jed2_user_notes (
  id INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  user_id INT(10) UNSIGNED NOT NULL DEFAULT 0,
  catid INT(10) UNSIGNED NOT NULL DEFAULT 0,
...
--
-- Описание для таблицы jed2_user_profiles
--
DROP TABLE IF EXISTS jed2_user_profiles;
CREATE TABLE jed2_user_profiles (
...
--
-- Описание для таблицы jed2_user_usergroup_map
--
DROP TABLE IF EXISTS jed2_user_usergroup_map;
CREATE TABLE jed2_user_usergroup_map (
...
--
-- Описание для таблицы jed2_usergroups
--
DROP TABLE IF EXISTS jed2_usergroups;
CREATE TABLE jed2_usergroups (
  id INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Описание для таблицы jed2_users
--
DROP TABLE IF EXISTS jed2_users;
CREATE TABLE jed2_users (
  id INT(11) NOT NULL AUTO_INCREMENT,
  name VARCHAR(255) NOT NULL DEFAULT '',
...
--
-- Описание для таблицы jed2_users_forum
--
DROP TABLE IF EXISTS jed2_users_forum;
CREATE TABLE jed2_users_forum (
  id INT(11) NOT NULL AUTO_INCREMENT,
  user_id INT(11) NOT NULL,
  PRIMARY KEY (id)
)
...
CHARACTER SET utf8
COLLATE utf8_general_ci
COMMENT = 'Table by default';

--
-- Описание для таблицы jed2_viewlevels
--
DROP TABLE IF EXISTS jed2_viewlevels;
CREATE TABLE jed2_viewlevels (
  id INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  title VARCHAR(100) NOT NULL DEFAULT '',
  ordering INT(11) NOT NULL DEFAULT 0,
  rules VARCHAR(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Описание для таблицы jed2_weblinks
--
DROP TABLE IF EXISTS jed2_weblinks;
CREATE TABLE jed2_weblinks (
  id INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  catid INT(11) NOT NULL DEFAULT 0,
...
-- 
-- Вывод данных для таблицы jed2_assets
--
INSERT INTO jed2_assets VALUES
...
(36, 1, 67, 68, 1, 'com_sample', 'com_sample', '{}');

-- 
-- Вывод данных для таблицы jed2_associations
--

-- Таблица joomla_ed2.jed2_associations не содержит данных

-- 
-- Вывод данных для таблицы jed2_banner_clients
--

-- Таблица joomla_ed2.jed2_banner_clients не содержит данных

-- 
-- Вывод данных для таблицы jed2_banner_tracks
--

-- Таблица joomla_ed2.jed2_banner_tracks не содержит данных

-- 
-- Вывод данных для таблицы jed2_banners
--

-- Таблица joomla_ed2.jed2_banners не содержит данных

-- 
-- Вывод данных для таблицы jed2_categories
--
INSERT INTO jed2_categories VALUES
...
-- 
-- Вывод данных для таблицы jed2_contact_details
--

-- Таблица joomla_ed2.jed2_contact_details не содержит данных

-- 
-- Вывод данных для таблицы jed2_content
--

-- Таблица joomla_ed2.jed2_content не содержит данных

-- 
-- Вывод данных для таблицы jed2_content_frontpage
--

-- Таблица joomla_ed2.jed2_content_frontpage не содержит данных

-- 
-- Вывод данных для таблицы jed2_content_rating
--

-- Таблица joomla_ed2.jed2_content_rating не содержит данных

-- 
-- Вывод данных для таблицы jed2_core_log_searches
--

-- Таблица joomla_ed2.jed2_core_log_searches не содержит данных

-- 
-- Вывод данных для таблицы jed2_extensions
--
INSERT INTO jed2_extensions VALUES
...
(10001, 'com_sample', 'component', 'com_sample', '', 1, 1, 0, 0, '{"legacy":false,"name":"com_sample","type":"component","creationDate":"\\u0414\\u0430\\u0442\\u0430 \\u0441\\u043e\\u0437\\u0434\\u0430\\u043d\\u0438\\u044f","author":"srgg","copyright":"Copyright (C) info.","authorEmail":"srgg67@gmail.com","authorUrl":"http:\\/\\/www.facebook.com\\/srgg67","version":"1.0.0","description":"\\u041e\\u043f\\u0438\\u0441\\u0430\\u043d\\u0438\\u0435 \\u043a\\u043e\\u043c\\u043f\\u043e\\u043d\\u0435\\u043d\\u0442\\u0430","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0);

-- 
-- Вывод данных для таблицы jed2_finder_filters
--

-- Таблица joomla_ed2.jed2_finder_filters не содержит данных

-- 
-- Вывод данных для таблицы jed2_finder_links
--

-- Таблица joomla_ed2.jed2_finder_links не содержит данных

-- 
-- Вывод данных для таблицы jed2_finder_links_terms0
--

-- Таблица joomla_ed2.jed2_finder_links_terms0 не содержит данных

-- 
-- Вывод данных для таблицы jed2_finder_links_terms1
--

-- Таблица joomla_ed2.jed2_finder_links_terms1 не содержит данных

-- 
-- Вывод данных для таблицы jed2_finder_links_terms2
--

-- Таблица joomla_ed2.jed2_finder_links_terms2 не содержит данных

-- 
-- Вывод данных для таблицы jed2_finder_links_terms3
--

-- Таблица joomla_ed2.jed2_finder_links_terms3 не содержит данных

-- 
-- Вывод данных для таблицы jed2_finder_links_terms4
--

-- Таблица joomla_ed2.jed2_finder_links_terms4 не содержит данных

-- 
-- Вывод данных для таблицы jed2_finder_links_terms5
--

-- Таблица joomla_ed2.jed2_finder_links_terms5 не содержит данных

-- 
-- Вывод данных для таблицы jed2_finder_links_terms6
--

-- Таблица joomla_ed2.jed2_finder_links_terms6 не содержит данных

-- 
-- Вывод данных для таблицы jed2_finder_links_terms7
--

-- Таблица joomla_ed2.jed2_finder_links_terms7 не содержит данных

-- 
-- Вывод данных для таблицы jed2_finder_links_terms8
--

-- Таблица joomla_ed2.jed2_finder_links_terms8 не содержит данных

-- 
-- Вывод данных для таблицы jed2_finder_links_terms9
--

-- Таблица joomla_ed2.jed2_finder_links_terms9 не содержит данных

-- 
-- Вывод данных для таблицы jed2_finder_links_termsa
--

-- Таблица joomla_ed2.jed2_finder_links_termsa не содержит данных

-- 
-- Вывод данных для таблицы jed2_finder_links_termsb
--

-- Таблица joomla_ed2.jed2_finder_links_termsb не содержит данных

-- 
-- Вывод данных для таблицы jed2_finder_links_termsc
--

-- Таблица joomla_ed2.jed2_finder_links_termsc не содержит данных

-- 
-- Вывод данных для таблицы jed2_finder_links_termsd
--

-- Таблица joomla_ed2.jed2_finder_links_termsd не содержит данных

-- 
-- Вывод данных для таблицы jed2_finder_links_termse
--

-- Таблица joomla_ed2.jed2_finder_links_termse не содержит данных

-- 
-- Вывод данных для таблицы jed2_finder_links_termsf
--

-- Таблица joomla_ed2.jed2_finder_links_termsf не содержит данных

-- 
-- Вывод данных для таблицы jed2_finder_taxonomy
--
INSERT INTO jed2_finder_taxonomy VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- 
-- Вывод данных для таблицы jed2_finder_taxonomy_map
--

-- Таблица joomla_ed2.jed2_finder_taxonomy_map не содержит данных

-- 
-- Вывод данных для таблицы jed2_finder_terms
--

-- Таблица joomla_ed2.jed2_finder_terms не содержит данных

-- 
-- Вывод данных для таблицы jed2_finder_terms_common
--
INSERT INTO jed2_finder_terms_common VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
-- 
-- Вывод данных для таблицы jed2_finder_tokens
--

-- Таблица joomla_ed2.jed2_finder_tokens не содержит данных

-- 
-- Вывод данных для таблицы jed2_finder_tokens_aggregate
--

-- Таблица joomla_ed2.jed2_finder_tokens_aggregate не содержит данных

-- 
-- Вывод данных для таблицы jed2_finder_types
--

-- Таблица joomla_ed2.jed2_finder_types не содержит данных

-- 
-- Вывод данных для таблицы jed2_languages
--
INSERT INTO jed2_languages VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 0, 1);

-- 
-- Вывод данных для таблицы jed2_menu
--
INSERT INTO jed2_menu VALUES
...
(103, 'main', 'COM_SAMPLE', 'com-sample', '', 'com-sample', 'index.php?option=com_sample', 'component', 0, 1, 1, 10001, 0, 0, '0000-00-00 00:00:00', 0, 1, 'class:sample', 0, '', 45, 46, 0, '', 1),
(104, 'mainmenu', 'Тест', 'test', '', 'test', 'index.php?option=com_sample&view=default', 'component', 1, 1, 1, 10001, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 47, 48, 0, '*', 0);

-- 
-- Вывод данных для таблицы jed2_menu_types
--
INSERT INTO jed2_menu_types VALUES
(1, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- 
-- Вывод данных для таблицы jed2_messages
--

-- Таблица joomla_ed2.jed2_messages не содержит данных

-- 
-- Вывод данных для таблицы jed2_messages_cfg
--

-- Таблица joomla_ed2.jed2_messages_cfg не содержит данных

-- 
-- Вывод данных для таблицы jed2_modules
--
INSERT INTO jed2_modules VALUES
...
-- 
-- Вывод данных для таблицы jed2_modules_menu
--
INSERT INTO jed2_modules_menu VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
-- 
-- Вывод данных для таблицы jed2_newsfeeds
--

-- Таблица joomla_ed2.jed2_newsfeeds не содержит данных

-- 
-- Вывод данных для таблицы jed2_overrider
--

-- Таблица joomla_ed2.jed2_overrider не содержит данных

-- 
-- Вывод данных для таблицы jed2_redirect_links
--
INSERT INTO jed2_redirect_links VALUES
(1, 'http://localhost/joomla-samples-2x/index.php?option=com_sample&view=default&Itemid=104', '', 'http://localhost/joomla-samples-2x/index.php?option=com_sample&view=default&Itemid=104', '', 1, 0, '2014-11-20 14:38:49', '0000-00-00 00:00:00');

-- 
-- Вывод данных для таблицы jed2_schemas
--
INSERT INTO jed2_schemas VALUES
(700, '2.5.8');

-- 
-- Вывод данных для таблицы jed2_session
--
INSERT INTO jed2_session VALUES
('3057aa0ac9e323a2af64751c40b5041b', 0, 1, '1416562376', '__default|a:8:{s:22:"session.client.browser";s:107:"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2225.0 Safari/537.36";s:15:"session.counter";i:44;s:8:"registry";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:4:"user";O:5:"JUser":25:{s:9:"\0*\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:8:"usertype";N;s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:0:{}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:10:"\0*\0_params";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:14:"\0*\0_authGroups";a:1:{i:0;i:1;}s:14:"\0*\0_authLevels";a:2:{i:0;i:1;i:1;i:1;}s:15:"\0*\0_authActions";N;s:12:"\0*\0_errorMsg";N;s:10:"\0*\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"81a1ed975af6b88eeb9d482b3f9630bc";s:19:"session.timer.start";i:1416555431;s:18:"session.timer.last";i:1416562022;s:17:"session.timer.now";i:1416562376;}', 0, '', '');

-- 
-- Вывод данных для таблицы jed2_template_styles
--
INSERT INTO jed2_template_styles VALUES
...
-- 
-- Вывод данных для таблицы jed2_update_categories
--

-- Таблица joomla_ed2.jed2_update_categories не содержит данных

-- 
-- Вывод данных для таблицы jed2_update_sites
--
INSERT INTO jed2_update_sites VALUES
(1, 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1416493759),
(2, 'Joomla Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1416493759),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist.xml', 1, 1416493759);

-- 
-- Вывод данных для таблицы jed2_update_sites_extensions
--
INSERT INTO jed2_update_sites_extensions VALUES
(1, 700),
(2, 700),
(3, 600);

-- 
-- Вывод данных для таблицы jed2_updates
--
INSERT INTO jed2_updates VALUES
...
(25, 3, 0, 0, 'German', '', 'pkg_de-DE', 'package', '', 0, '2.5.27.1', '', 'http://update.joomla.org/language/details/de-DE_details.xml', ''),
(26, 3, 0, 0, 'Norwegian Bokmal', '', 'pkg_nb-NO', 'package', '', 0, '2.5.27.1', '', 'http://update.joomla.org/language/details/nb-NO_details.xml', ''),
...
(36, 3, 0, 0, 'Syriac', '', 'pkg_sy-IQ', 'package', '', 0, '2.5.25.1', '', 'http://update.joomla.org/language/details/sy-IQ_details.xml', ''),
...
(40, 3, 0, 0, 'Catalan', '', 'pkg_ca-ES', 'package', '', 0, '2.5.27.1', '', 'http://update.joomla.org/language/details/ca-ES_details.xml', ''),
...
(45, 3, 0, 0, 'Finnish', '', 'pkg_fi-FI', 'package', '', 0, '2.5.25.1', '', 'http://update.joomla.org/language/details/fi-FI_details.xml', ''),
(46, 3, 0, 0, 'Portuguese Brazil', '', 'pkg_pt-BR', 'package', '', 0, '2.5.9.1', '', 'http://update.joomla.org/language/details/pt-BR_details.xml', ''),
(47, 3, 0, 0, 'Chinese Traditional', '', 'pkg_zh-TW', 'package', '', 0, '2.5.27.1', '', 'http://update.joomla.org/language/details/zh-TW_details.xml', ''),
...
(55, 3, 0, 0, 'Tamil India', '', 'pkg_ta-IN', 'package', '', 0, '2.5.27.1', '', 'http://update.joomla.org/language/details/ta-IN_details.xml', ''),
(56, 3, 0, 0, 'Scottish Gaelic', '', 'pkg_gd-GB', 'package', '', 0, '2.5.7.1', '', 'http://update.joomla.org/language/details/gd-GB_details.xml', ''),
(57, 3, 0, 0, 'Thai', '', 'pkg_th-TH', 'package', '', 0, '2.5.27.1', '', 'http://update.joomla.org/language/details/th-TH_details.xml', ''),
...
(63, 3, 0, 0, 'Swahili', '', 'pkg_sw-KE', 'package', '', 0, '2.5.27.1', '', 'http://update.joomla.org/language/details/sw-KE_details.xml', '');

-- 
-- Вывод данных для таблицы jed2_user_notes
--

-- Таблица joomla_ed2.jed2_user_notes не содержит данных

-- 
-- Вывод данных для таблицы jed2_user_profiles
--

-- Таблица joomla_ed2.jed2_user_profiles не содержит данных

-- 
-- Вывод данных для таблицы jed2_user_usergroup_map
--
INSERT INTO jed2_user_usergroup_map VALUES
(583, 8),
(584, 6),
(585, 2),
(585, 3),
...
-- 
-- Вывод данных для таблицы jed2_usergroups
--
INSERT INTO jed2_usergroups VALUES
(1, 0, 1, 20, 'Public'),
(2, 1, 6, 17, 'Registered'),
(3, 2, 7, 14, 'Author'),
(4, 3, 8, 11, 'Editor'),
...
-- 
-- Вывод данных для таблицы jed2_users
--
INSERT INTO jed2_users VALUES
(583, 'Super User', 'admin', 'srgg67@gmail.com', 'cf8a02093ba033086a37b56ad69ccfd0:XPYc1NKgggel0aAG8wusbghmpGJHSYcr', 'deprecated', 0, 1, '2014-11-20 11:09:16', '2014-11-20 13:14:50', '0', '', '0000-00-00 00:00:00', 0),
(584, 'Вася', 'pupkine', 'pupkine@vasja.com', 'd952314d00966ca3b1a6b2b77eb93922:P61KJxKi52vrEIwxBKCyZ6ogpSpdMs3c', '', 0, 0, '2014-11-20 14:30:13', '0000-00-00 00:00:00', '', '{"admin_style":"","admin_language":"","language":"","editor":"","helpsite":"","timezone":""}', '0000-00-00 00:00:00', 0),
(585, 'Петя', 'nozhkin', 'nozhkine@petja.com', 'e8cdd16884855fcbad30f533dc6e80da:Lfrh67IxoQ9XDSgynTYmi6OoqrIKnC6Q', '', 0, 0, '2014-11-20 14:31:10', '0000-00-00 00:00:00', '', '{"admin_style":"","admin_language":"","language":"","editor":"","helpsite":"","timezone":""}', '0000-00-00 00:00:00', 0),
(586, 'Лёша', 'fishin', 'lyosha@rybkine.net', '52c49c116dc59e3e16f187812aa128d3:QKF7dFURhN24DVW9QC12SKGDK1YHREHV', '', 0, 0, '2014-11-20 14:31:47', '0000-00-00 00:00:00', '', '{"admin_style":"","admin_language":"","language":"","editor":"","helpsite":"","timezone":""}', '0000-00-00 00:00:00', 0),
(587, 'Света', 'belkina', 'sveta@belkina.ru', 'e71cd91a4ad552ad4874517d68cc7acb:1koPru02bMjS3YgvpkUOWIpwDJ7mnJnc', '', 0, 0, '2014-11-20 14:32:43', '0000-00-00 00:00:00', '', '{"admin_style":"","admin_language":"","language":"","editor":"","helpsite":"","timezone":""}', '0000-00-00 00:00:00', 0),
(588, 'Алёна', 'alyona', 'alyouna@goryachkina.nl', '9051c349854c794f5cff4dc01f880a87:hyVRB4cOklhAefJOncJ1SmTdsUD6167S', '', 0, 0, '2014-11-20 14:33:22', '0000-00-00 00:00:00', '', '{"admin_style":"","admin_language":"","language":"","editor":"","helpsite":"","timezone":""}', '0000-00-00 00:00:00', 0),
(589, 'Гаврила', 'haurillo', 'haurillo@unknown.com', 'a457eb66a03195f40acce34bb8d2561f:IGQTjFyhw6hF2NLFF8OzLTFraHa345bG', '', 0, 0, '2014-11-20 14:34:13', '0000-00-00 00:00:00', '', '{"admin_style":"","admin_language":"","language":"","editor":"","helpsite":"","timezone":""}', '0000-00-00 00:00:00', 0);

-- 
-- Вывод данных для таблицы jed2_users_forum
--
INSERT INTO jed2_users_forum VALUES
(1, 583),
(2, 584),
(3, 585),
(4, 586),
...
-- 
-- Вывод данных для таблицы jed2_viewlevels
--
INSERT INTO jed2_viewlevels VALUES
(1, 'Public', 0, '[1]'),
(2, 'Registered', 1, '[6,2,8]'),
(3, 'Special', 2, '[6,3,8]');

-- 
-- Вывод данных для таблицы jed2_weblinks
--

-- Таблица joomla_ed2.jed2_weblinks не содержит данных
